        ...
        <PageSection title="系统信息">
          <div className="system-info-grid">
            ...
            <div className="info-field-grid">
              ...
              <InfoField label="系统时间" value={data.systemInfo?.system_time} mono />
              <InfoField label="系统时区" value={data.systemInfo?.system_timezone && `${data.systemInfo.system_timezone} (${data.systemInfo.system_utc_offset})`} mono />
