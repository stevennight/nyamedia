...
export const api = {
  ...
  getProviderBaiduOpenAuthConfig: (providerId, options = {}) => apiFetch(`/api/v1/providers/${encodeURIComponent(providerId)}/auth/baiduopen`, options),
  ...
  saveProviderBaiduOpenAuthMode: (providerId, mode) => apiFetch(`/api/v1/providers/${encodeURIComponent(providerId)}/auth/baiduopen/mode`, { method: 'PUT', body: JSON.stringify({ mode }) }),
